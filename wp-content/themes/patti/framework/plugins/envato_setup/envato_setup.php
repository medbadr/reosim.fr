...
if ( ! class_exists( 'Envato_Theme_Setup_Wizard' ) ) {
	...
	class Envato_Theme_Setup_Wizard {
		...
		public function get_logo_image() {
			...
			if ( $logo_image_id ) {
				...
				$image_url = get_theme_mod( 'logo_header_image',$this->plugin_url . 'images/logo.png' );
			}
		...
		public function init_globals() {
			...
			$this->envato_username = apply_filters( $this->theme_name . '_theme_setup_wizard_username', 'delicious' );
			$this->oauth_script    = apply_filters( $this->theme_name . '_theme_setup_wizard_oauth_script', 'https://deliciousthemes.com/envato/api/server-script.php' );
	...
	public function setup_wizard_header() {
		...
		<h1 id="wc-logo">
			<a href="http://themeforest.net/user/deliciousthemes/portfolio" target="_blank"><?php
		...
		public function envato_setup_introduction() {
			...
			if ( false && isset( $_REQUEST['debug'] ) ) {
				...
				?>
				<h1><?php printf( esc_html__( 'Welcome to the setup wizard for %s.' ), wp_get_theme() ); ?></h1>
				<p><?php printf( esc_html__( 'Thank you for choosing the %s theme from ThemeForest. This quick setup wizard will help you configure your new website. This wizard will install the required WordPress plugins and tell you a little about your options. It should only take a few minutes.' ), wp_get_theme() ); ?></p>
				<p><?php esc_html_e( 'No time right now? If you don\'t want to go through the wizard, you can skip and return to the WordPress dashboard. Come back anytime at Appearance->Setup Wizard if you change your mind!' ); ?></p>
				<p class="envato-setup-actions step">
					<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
					   class="button-primary button button-large button-next"><?php esc_html_e( 'Let\'s Go!' ); ?></a>
					<a href="<?php echo esc_url( wp_get_referer() && ! strpos( wp_get_referer(), 'update.php' ) ? wp_get_referer() : admin_url( '' ) ); ?>"
						...
						<p>
							<em>On the next page you will be asked to Login with your ThemeForest account and grant
								permissions to enable Automatic Updates. If you have any questions please <a
									href="https://deliciousthemes.ticksy.com/" target="_blank">contact us</a>.</em>
						</p>
						<p class="envato-setup-actions step">
							<input type="submit" class="button-primary button button-large button-next"
		...
		public function envato_setup_help_support() {
			...
			<p>Item Support can be accessed from <a href="https://deliciousthemes.ticksy.com/" target="_blank">https://deliciousthemes.ticksy.com/</a>
				and includes:</p>
			<ul>
		...
		public function envato_setup_ready() {
			...
			<a href="https://twitter.com/share" class="twitter-share-button"
			   data-url="http://themeforest.net/user/deliciousthemes/portfolio?ref=deliciousthemes"
			...
			<h1><?php esc_html_e( 'The theme is Ready!' ); ?></h1>
			...
			<div class="envato-setup-next-steps">
				<div class="envato-setup-next-steps-first">
					...
					<ul>
						<li class="setup-product"><a class="button button-primary button-large"
						                             href="<?php echo esc_url( admin_url('themes.php?page=pt-one-click-demo-import') ); ?>"
						                             ><?php esc_html_e( 'Import Demo Data' ); ?></a>
						</li>						
						<li class="setup-product"><a target="_blank" class="button button-next button-large"
				...
				<div class="envato-setup-next-steps-last">
					...
					<ul>
						...
						<li class="support"><a href="https://deliciousthemes.ticksy.com/"
