...
$post_types      = array( 'attachment', 'wpcf7_contact_form', 'post', 'page', 'portfolio' );
...
//			print_r($meta); exit;
		...
		if ( $post_type == 'attachment' ) {
			...
			if ( is_file( $file ) ) {
				...
				if ( is_dir( get_home_path() . '/../patti/assets/images/stock/' ) ) {
					copy( $file, get_home_path() . '/../patti/assets/images/stock/' . basename( $file ) );
				}
			}
...
$dir = get_home_path() . '/../patti/framework/plugins/envato_setup/content/';
...
?>
	<h1>Export Done:</h1>
	<p>Export content has been placed into /patti/framework/plugins/envato_setup/content/*.json files</p>
	<p>Stock images have been copied into /patti/assets/images/stock/ for faster theme install.</p>
<?php