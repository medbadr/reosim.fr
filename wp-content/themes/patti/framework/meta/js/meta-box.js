...
$(window).load(function() {
  ...
  if($("select[name='dt_portf_icon'] option:selected").val() == 'link_to_link') {
    ...
    $('select[name="dt_portf_icon"]').on("change", function(event){
     ...
     if(str == 'link_to_link') { 
         ...
         $("#dt_portf_link_newtab").fadeIn();
      }
      else { 
          $("#dt_portf_link").hide();
          $("#dt_portf_link_newtab").hide();
       }
    }); 
  ...
  if($("#dt_portfolio_navigation input[value='no-filter']:checked").val() == 'no-filter') {
	...
	jQuery.fn.extend({
      ...
      var theSelectedFormat  = $this.attr("id");
			var theSelectedFormatGutenberg  = $this.attr("value");
     ...
     var post_formats_gutenberg = {};
      post_formats_gutenberg['standard'] = "#dt_standard_post_custom_fields";
      post_formats_gutenberg['gallery'] = "#dt_gallery_post_custom_fields";
      post_formats_gutenberg['link'] = "#dt_link_post_custom_fields";
      post_formats_gutenberg['quote'] = "#dt_quote_post_custom_fields";
      post_formats_gutenberg['audio'] = "#dt_audio_post_custom_fields";
      post_formats_gutenberg['video'] = "#dt_video_post_custom_fields";

  
        for (var key in post_formats_gutenberg) {
          jQuery(post_formats_gutenberg[key]).css({"display":"none"});
        }
  
      jQuery(post_formats_gutenberg[theSelectedFormatGutenberg]).css({"display":"block"});
  ...
  jQuery(".editor-post-format select option:selected").ShowPostFormats();
    jQuery(".editor-post-format select").on("change", function(event){
      jQuery(".editor-post-format select option:selected").ShowPostFormats();
  }); 		
	...
	jQuery(".editor-page-attributes__template #inspector-select-control-1 option:selected").ShowPageFields();

    jQuery(".editor-page-attributes__template #inspector-select-control-1").on("change", function(event){
    jQuery(".editor-page-attributes__template #inspector-select-control-1 option:selected").ShowPageFields();
  }); 
