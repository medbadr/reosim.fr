...
?>
	...
	<div class="centered-wrapper">	
		<section id="blog" class="post-single">
			...
			<?php
				$thumbnailsize = '';
				if(isset($smof_data['thumbnail_size'])) { if($smof_data['thumbnail_size'] !='') { $thumbnailsize = $smof_data['thumbnail_size']; } } else $$thumbnailsize = 'fullwidth-thumbnail'; 
			?>

				<div class="percent-blog <?php echo $thumbnailsize ?> begin-content <?php if(isset($smof_data['blog_sidebar_pos'])) { if($smof_data['blog_sidebar_pos'] !='') { echo $smof_data['blog_sidebar_pos']; } } else echo 'sidebar-right'; ?>">
				<?php
						...
						<?php if(isset($smof_data['author_box'])) { if($smof_data['author_box'] =='1') { ?>
							...
							<div class="author-bio">							
								...
								<div class="authorp vcard author">
									<h2><?php _e('Author: ', 'delicious'); ?><span class="fn"><?php the_author_link(); ?></span></h2>
