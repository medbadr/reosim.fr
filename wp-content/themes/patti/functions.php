...
if( !function_exists('delicious_enqueue_scripts') ) {
	...
	function delicious_enqueue_scripts() {
		...
		wp_register_script('dt-isotope-new', get_template_directory_uri() . '/js/jquery.isotope.new.min.js', array('jquery'), '3.0.1', true );
		wp_register_script('packery', get_template_directory_uri() . '/js/jquery.packery.js', array('jquery'), '2.0', true );
		...
		wp_register_script('dt-custom-isotope-portfolio-new', get_template_directory_uri() . '/js/custom/custom-isotope-portfolio-new.js', array('jquery', 'dt-isotope'), '1.0', true );
		...
		wp_localize_script( 'dt-custom-isotope-portfolio-new', 'vals', array( 'grid_manager' => $grid_manager, 'grid_very_wide' => $grid_very_wide, 'grid_wide' => $grid_wide, 'grid_normal' => $grid_normal, 'grid_small' => $grid_small, 'grid_tablet' => $grid_tablet, 'grid_phone' => $grid_phone, 'grid_small_phone' => $grid_small_phone, 'grid_gutter_width' => $grid_gutter_width) );		
	...
	function delicious_video($postid) { 
		...
		if(($external_item != '')) {
			...
			if( strpos($external_item, 'vimeo') ) {
				...
				echo '<div class="post-video"><iframe src="//player.vimeo.com/video/'.$id.'?title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;color=ffffff" width="'.$width.'" height="'.$height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>';	
			}			
		}
